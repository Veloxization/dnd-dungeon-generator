...
class ImageGenerationService:
    ...
    def generate_grid(self, cell_width=20, cell_height=20, line_thickness=1):
        ...
        while current_coordinate < self._map_width:
            self._image_draw.line((current_coordinate, 0, current_coordinate, self._map_height),
                                   fill=line_color,
        ...
        while current_coordinate < self._map_height:
            self._image_draw.line((0, current_coordinate, self._map_width, current_coordinate),
                                   fill=line_color,
                                   width=line_thickness)
