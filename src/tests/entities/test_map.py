...
class TestMap(unittest.TestCase):
    ...
    def test_the_top_left_corner_only_has_two_neighbours(self):
        self.assertEqual(len(self.test_map1.get_adjacent_cells(0, 0)), 2)

    def test_an_edge_cell_has_three_neighbours(self):
        self.assertEqual(len(self.test_map1.get_adjacent_cells(0,1)), 3)

    def test_a_middle_cell_has_four_neighbours(self):
        self.assertEqual(len(self.test_map1.get_adjacent_cells(1, 1)), 4)
